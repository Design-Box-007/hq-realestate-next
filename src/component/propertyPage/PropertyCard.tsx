          ...
          <div className="px-4 py-3 sm:px-3 sm:py-2">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-4 gap-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-2xl lg:text-3xl font-medium">{property.title}</span> {/* Text size slightly smaller for mobile */}
              </div>
            ...
            <div className="w-full transition-all duration-300 flex gap-3 flex-col sm:flex-row">
              {property.contactLinks?.phone && (
                <a
                  ...
                  className="flex-1 flex items-center justify-between !rounded-full bg-[#171717] py-2 px-3 text-white hover:border-[#EDBE8C] transition-all"
                >
